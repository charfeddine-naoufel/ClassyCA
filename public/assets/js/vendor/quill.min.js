        ...
        function (t, e, n) {
            ...
            function c(t, e) {
                ...
                if (!(t.index >= this.quill.getLength() - n)) {
                    ...
                    this.quill.deleteText(t.index, n, L.default.sources.USER),
            ...
            function f(t) {
                ...
                this.quill.deleteText(t, L.default.sources.USER),
                    ...
                    this.quill.setSelection(t.index, L.default.sources.SILENT),
                    this.quill.focus();
            }
            ...
            function y(t) {
                ...
                if (
                    ...
                    if (null != F.keys[t.key.toUpperCase()])
                        t.key = F.keys[t.key.toUpperCase()];
                    else {
                        if (1 !== t.key.length) return null;
                        t.key = t.key.toUpperCase().charCodeAt(0);
                    }
                return (
                    t.shortKey && ((t[U] = t.shortKey), delete t.shortKey), t
                );
            }
            Object.defineProperty(e, "__esModule", { value: !0 }),
