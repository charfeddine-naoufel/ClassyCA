...
<body>
        ...
        <div class="container">
            <div class="main-content text-center">
                ...
                <div class="mb-48">
                  ...
                  <a href="http://demos.ui-lib.com/gull-html-doc/" target="_blank" class="mx-8 text-muted font-weight-bold">HTML/Laravel Doc</a>
                  <a href="https://ui-lib.com/github-access/" target="_blank" class="mx-8 text-muted font-weight-bold">Github Access</a>
                </div>
            ...
            <div class="row clearfix">
                <div class="col-md-8 mx-auto">
                    <div class="demo-photo text-center mb-4">
                        <a href="http://gull-html-laravel.ui-lib.com" target="_blank" class="thumbnail card o-hidden mb-24">
                            <img src="{{asset('assets/images/gull-large-sidebar.png')}}" alt="">
                        </a>
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-raised btn-raised-primary rounded" target="_blank" href="http://gull.ui-lib.com">Preview Angular</a>
                            <span style="width: 20px"></span>
                            <a class="btn btn-raised btn-raised-primary rounded" target="_blank" href="http://gull-html-laravel.ui-lib.com">Preview HTML/Laravel</a>    
                        </div>
                    </div>
                </div>
                <!-- <div class="col-md-6">
        ...
        <div class="container">
            ...
            <div class="complement">
                <div class="client-card card ml-3">
                    <div class="user d-flex">
                        <div class="user-photo">
                            <img src="https://public-assets.envato-static.com/assets/common/icons-buttons/default-user-2962fd43ee315eafee8bfc08f02fee84687beb0499de44e5ab2873399944b0fe.jpg" alt="">
                        </div>
                    ...
                    <div class="user-comment">
                        <p>Design quality and customer support are excellent. Seller returns advice very quickly, especially as I am new to Laravel, which I cannot praise enough. Thank you</p>
                    </div>
                </div>
                <div class="client-card card">
                    ...
                    <div class="user-comment">
                        <p>I just started using this template, So far what I like is that it's not only beautiful and packed with features. But it appears to be a full Angular and TypeScript template.
                          <br><br>
                            A lot of templates claim to be built with Angular but are actually JQuery Templates inside of Angular. 
                            I've had a bad experience with one of those.
                            <br><br>
                            I'm looking forward to working more with this template and even learning a few Angular concepts from it.</p>
                    </div>
                </div>
                <div class="client-card card ml-3">
                    <div class="user d-flex">
                    ...
                    <div class="user-comment">
                        <p>It's very easy template for laravel, i'have just launch 'composer install' and 'npm run dev' and i can work ! congratulations !!</p>
                    </div>
                </div>
                <div class="client-card card">
                    <div class="user d-flex">
                    ...
                    <div class="user-comment">
                        <p>If you are a laravel user, please purchase it unconditionally. Easy. Fast. Good. Good quality. </p>
                    </div>
                </div>
                <div class="client-card card ml-3">
                    <div class="user d-flex">
                ...
                <div class="client-card card">
                    ...
                    <div class="user-comment">
                        <p>Truly one of the highest quality and greatest value items purchased on Themeforest, in addition to a great product stands an awesome creator who quickly replies to comments and questions.
                        <br>
                        <br>
                        Thank you!!!</p>
                    </div>
    ...
    <section class="blog">
        <div class="container">
            ...
            <p class="text-16">Gull is just like the car in the above analogy. Yeah, it's powerful enough on its own right. But, it aims at SAVING your TIME. 
            ...
            <p class="text-16">If you are looking for a quality admin template to boost your ongoing startup application or are merely looking for pre-built chat application, 
            ...
            <div class="row footer-item">
                ...
                <div class="col-md-4">
                    <div class="selling-btn">
                        <a class="btn btn-raised btn-raised-primary btn-xl rounded" href="https://themeforest.net/item/gull-bootstrap-laravel-admin-dashboard-template/23101970">Buy Gull</a>
                    </div>
                </div>
                <div class="col-md-4">
                    <!-- <div class="btn-arrow">
