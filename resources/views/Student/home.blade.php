...
<div class="main-content-wrap sidenav-open d-flex flex-column">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-md-2 text-center">
                                    ...
                                    @else
                                        ...
                                        <img
                                            src="{{ asset('assets/images/faces/face2.png') }}"
                                            class="rounded-circle"
                                            width="120">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <h3 class="heading display-5 text-white">Bonjour
                                        {{ $student->prenom_fr }}
                                        {{ $student->nom_fr }}
                                    </h3>
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card mb-4 o-hidden h-100 shadow">
                        
                        <div class="card-header bg-transparent">
            
                            <h4>
                                <i class="i-Library mr-2 text-primary"></i>
                            ...
                            <div class="row">
                                ...
                                @forelse($courses as $course)
                                    ...
                                    <div class="col-xl-3 col-lg-3 col-md-6 mb-4">
                                        ...
                                        <div class="card mb-4 o-hidden shadow h-100">
                                            ...
                                            <ul class="list-group list-group-flush">
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <i class="i-Library text-primary mr-2"></i>
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <i class="i-File text-success mr-2"></i>
                        
                                                    <strong>Chapitres :</strong>
                        
                                                    {{ $course->chapitres->count() }}
                        
                                                </li>
                        
                                                <li class="list-group-item">
                        
                                                    <i class="i-Video text-danger mr-2"></i>
                        
                                                    <strong>Vidéos :</strong>
                        
                                                    {{ $course->chapitres->sum(fn($chapitre) => $chapitre->seances->count()) }}
                                            ...
                                            <div class="card-body d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="{{ route('student.chapitrescours',$course->id) }}"
